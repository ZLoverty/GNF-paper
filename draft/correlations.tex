...
\begin{abstract}
Active systems across multiple length scales exhibit strong density correlations and fluctuations. Though these phenomena appear to be universal in many systems, the underlying mechanisms can be different. We report simultaneous measurements on correlations and number fluctuations in \textit{E. coli} suspensions at various concentrations. The results suggest that the fluid flow induced by the swimming of bacteria determines the how strong the number fluctuation is. The finding is supported by our kinetics measurements and detailed flow-concentration correlation analysis. We also examine the role of dimensionality and find that number fluctuations get weaker when approaching a quasi-2D condition.
\end{abstract}
...
\begin{figure}[!]
\begin{center}
\includegraphics[width=0.5\textwidth]{GNF_figures-7-v1.png}
