...
\definecolor{darkgreen}{rgb}{0.07, 0.45, 0.03}
% Comment type:
...
\begin{figure}[t]
	\begin{center}
		\includegraphics[width=0.47\textwidth]{figures/GNF/v8.pdf}
...
\begin{figure*}[t]
\begin{center}
\includegraphics[width=0.9\textwidth]{figures/GNF-energy-spectra-correlation-transient/v8.pdf}
...
\begin{figure}[t]
	\begin{center}
		\includegraphics[width=0.4\textwidth]{figures/GNF-calculation/v2.pdf}
...
\begin{figure}[t]
	\begin{center}
		\includegraphics[width=0.46\textwidth]{Figures/local-correlation/v2.pdf}
		\caption[Density autocorrelation]
		{
