...
\textcolor{red}{We show that giant number fluctuations (GNF) exist in three-dimensional (3D) bacterial suspensions, even at volume fractions well below the the transition to active turbulence. By comparing the measurements of GNF and energy spectra, we reveal a strong coupling between the two quantities. We show that such coupling is ensity-independent and scale-invariant. Experiments with light-powered \textit{E. coli} reveal that the coupling is universal, existing in both steady and transient states of active turbulence. Moreover, our experiments support several theoretical predictions: 1) GNF scaling law in 3D self-propelled particle suspensions predicted by a hydrodynamic model, 2) correlated swimming well below the turbulent transition and 3) the delay of the GNF onset compared to the collective flows predicted by the kinetic theories.}
